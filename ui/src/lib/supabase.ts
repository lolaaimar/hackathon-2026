...
export async function saveDescriptions(descs: ProposalDescription[]): Promise<void> {
  await supabase.from('proposal_descriptions').upsert(descs, { onConflict: 'proposal_id' });
}
